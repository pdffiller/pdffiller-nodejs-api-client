...
class FillableForms extends Base {
   ...
   * @param {number} linkToFillId id of fill request
   * @returns {Promise} with buffer object or json object with created Job information
   */
   ...
   * @returns {Promise}
   */
  exportFilled(linkToFillId, filledFormId) {
    return this.request({
   ...
   * @returns {Promise}
   */
  downloadFilled(linkToFillId, filledFormId) {
    return this.request({
   ...
   * @returns {Promise}
   */
  getFilledAllAdditional(linkToFillId, filledFormId) {
    return this.request({
   ...
   * @returns {Promise}
   */
  getFilledAdditional(linkToFillId, filledFormId, additionalDocumentId) {
    return this.request({
   ...
   * @returns {Promise}
   */
  downloadFilledAdditional(linkToFillId, filledFormId, additionalDocumentId) {
    return this.request({
   ...
   * @returns {Promise}
   */
  downloadFilledAllAdditional(linkToFillId, filledFormId) {
    return this.request({
