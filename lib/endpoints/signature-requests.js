...
class SignatureRequests extends Base {
   ...
   * @returns {Promise}
   */
  getCertificate(signatureRequestId) {
    return this.request({
   ...
   * @returns {Promise}
   */
  getRecipientAllAdditional(signatureRequestId, recipientId) {
    return this.request({
   ...
   * @returns {Promise}
   */
  getRecipientAdditional(signatureRequestId, recipientId, additionalDocumentId) {
    return this.request({
   ...
   * @returns {Promise}
   */
  downloadRecipientAdditional(signatureRequestId, recipientId, additionalDocumentId) {
    return this.request({
   ...
   * @returns {Promise}
   */
  downloadRecipientAllAdditional(signatureRequestId, recipientId) {
    return this.request({
